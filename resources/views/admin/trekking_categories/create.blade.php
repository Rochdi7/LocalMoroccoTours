...
@section('title', 'Create Trekking Category')
...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="{{ route('admin.trekking-categories.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf

            <div id="trekking-form-card" class="card animate__animated animate__fadeInUp">
                <div class="card-header">
                    <h5 class="mb-0">New Trekking Category Form</h5>
                </div>
