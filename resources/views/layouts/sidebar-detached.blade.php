    ...
    <div class="navbar-content">
      ...
      <div class="card nav-action-card bg-brand-color-4">
        <div class="card-body" style="background-image: url('/build/images/layout/nav-card-bg.svg')">
          ...
          <a href="https://CodeSommet.support-hub.io/" class="btn btn-primary" target="_blank">Go to help Center</a>
        </div>
      </div>
    </div>
    ...
    @endphp
        ...
        @endphp
                  ...
                  <div class="flex-grow-1 me-2">
                    ...
                    <small class="text-body">{{ ucfirst($auth->getRoleNames()->first() ?? 'User') }}</small>
                  </div>
