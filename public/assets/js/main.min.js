...
noUiSlider.create(slider,{start:[0,5000],step:1,connect:!0,range:{'min':0,'max':5000},format:{to:function(value){return"$"+value.toFixed(0)},from:function(value){return value}}})
